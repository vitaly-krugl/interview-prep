...
* Work in progress - major refactoring: [Refactor interfaces and make TCP/SSL connection setup non-blocking](https://github.com/pika/pika/pull/1002)
...
* Code Review: [Blocked method should not prevent closing a channel](https://github.com/pika/pika/pull/991)
